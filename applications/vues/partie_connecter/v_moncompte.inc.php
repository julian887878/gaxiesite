                ...
                <form id="main-contact-form" class="contact-form" name="contact-form" method="post" action="sendemail.php">
                    <div class="col-sm-5 col-sm-offset-1">
                        <div class="form-group">
                            <label>Nom</label><br>
                        <?php echo"<input type='text' name='name' value='$infos->nomUtilisateur' class='form-control' required='required'>"; ?>
                        </div>  
                        <div class="form-group">
                            <label>Prénom</label>
                       <?php echo"<input type='text' name='name' value='$infos->prenomUtilisateur' class='form-control' required='required'>"; ?>
                        </div>
                        <div class='form-group'>
                            <label>Email</label>
                        ...
                        <div class='form-group'>
                         ...
                         <?php echo"<input type='text' value='$infos->telUtilisateur' class='form-control'>"; ?>
                        </div>
                        <div class='form-group'>
                            <label>Poste</label>
                        <?php echo"<input type='text' value='$infos->posteUtilisateur' class='form-control'>"; ?>
                        </div>   
                        <div class="form-group">
